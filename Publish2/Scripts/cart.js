(function () {
    ...
    function isCourierMethod(method) {
        return method === 'courier' || method === 'dpd-courier' || method === 'gls-courier';
    }
    ...
    function renderCart() {
        ...
        Object.keys(cart).forEach(key => {
            ...
            // Create a flex container for image and product info
            ...
            if (qualifiesForDiscount) {
                ...
                priceSpan.innerHTML = '<span>€' + lineTotal + '</span>';
            }
        ...
        // show final total in the UI, same as Kosik total
        totalAmountEl.textContent = totals.total.toFixed(2);
        // expose both final total and raw subtotal for any other scripts
        totalAmountEl.setAttribute('data-total', totals.total.toFixed(2));
    ...
    function renderFavorites() {
        ...
        favIds.forEach(id => {
            ...
            if (qualifiesForDiscountFav) {
                ...
                discountedPriceText = '<span style="text-decoration:line-through;color:#999;margin-right:.4rem;">€' + (price.toFixed(2)) + '</span><span> €' + discountedPrice + '</span>';
            } else {
                discountedPriceText = '<span>€' + price.toFixed(2) + '</span>';
            }
            priceSpan.innerHTML = discountedPriceText;
