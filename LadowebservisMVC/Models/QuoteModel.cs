...
namespace UmbracoEshop.lib.Models
{
    ...
    public class QuoteModel
    {
        ...
        public void CopyDataFrom(QuoteModel src)
        {
            ...
            this.QuotePriceNoVat = src.QuotePriceNoVat;
            this.QuotePriceWithVat = src.QuotePriceWithVat;
            this.QuoteState = src.QuoteState;
            this.QuotePriceState = src.QuotePriceState;
            this.Note = src.Note;
        }

        public void CopyDataTo(QuoteModel trg)
        {
            ...
            trg.QuotePriceNoVat = this.QuotePriceNoVat;
            trg.QuotePriceWithVat = this.QuotePriceWithVat;
            trg.QuoteState = this.QuoteState;
            trg.QuotePriceState = this.QuotePriceState;
            trg.Note = this.Note;
        }

        public static QuoteModel CreateCopyFrom(QuoteModel src)
        {
