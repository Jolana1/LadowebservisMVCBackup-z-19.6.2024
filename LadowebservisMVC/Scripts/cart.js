    ...
    function renderCart() {
        ...
        Object.keys(cart).forEach(key => {
            ...
            if (qualifiesForDiscount) {
                priceSpan.innerHTML = '<span style="text-decoration:line-through;color:#999;margin-right:.4rem;">€' + baseLine.toFixed(2) + '</span><span> €' + lineTotal + '</span>';
            } else {
