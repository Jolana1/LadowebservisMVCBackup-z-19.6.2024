...
namespace LadowebservisMVC.Models.Captcha
{
    public class DufeksoftRecaptcha
    {
        ...
        public DufeksoftRecaptchaKey GetNewKey()
        {
            DateTime now = DateTime.Now;
            DateTime later = now.AddMilliseconds(ticksOffset);

            DufeksoftRecaptchaKey ret = new DufeksoftRecaptchaKey()
            {
        ...
        public bool IsValid(string apiKey1, string apiKey2)
        {
            ...
            try
            {
                return IsValid(new DufeksoftRecaptchaKey() { MainKey = apiKey1, SubKey = apiKey2 });
            }
            catch
            {
                return false;
        ...
        public bool IsValid(DufeksoftRecaptchaKey keyPair)
        {
    ...
    public class DufeksoftRecaptchaKey
    {
